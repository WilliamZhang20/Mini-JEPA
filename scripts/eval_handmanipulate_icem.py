...
class ICEM:
    def __init__(self, wm, norm, spec, dev, *, H, N, iters, elite_frac, init_std, beta,
                 keep_frac, exec_k, disagree_w, reset_w, path_w, fine_deg=0.0, fine_H=8, fine_N=512):
...
def main() -> None:
    ...
    env.close()
    print(json.dumps({"event": "handmanipulate_icem_eval", "task": task.name, "horizon": H,
