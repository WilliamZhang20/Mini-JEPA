...
from scripts.eval_hjepa_maze import LowLevelBC, build_subgoal_graph, dijkstra_path
...
def main() -> None:
    ...
    for ep in range(args.tries):
        ...
        if success > 0.5:
            imageio.mimsave(args.out, frames[::2], fps=30, format="FFMPEG")  # subsample frames (long episodes)
