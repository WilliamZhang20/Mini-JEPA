"""Model-based RL loop (GC-PMPC style) for demo-free in-hand reorientation.
...
def main() -> None:
    ...
    for r in range(args.rounds):
        ...
        print(json.dumps({"event": "mbrl_round", "round": r, "task_success": round(succ, 3),
        ...
        model_path = wm_out
        print(json.dumps({"event": "mbrl_retrained", "round": r, "wm": str(wm_out)}), flush=True)
    env.close()
    print(json.dumps({"event": "mbrl_done", "final_wm": str(model_path)}), flush=True)
